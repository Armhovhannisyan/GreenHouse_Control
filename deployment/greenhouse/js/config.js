...
const CONFIG = {
  ...
  backendBaseUrl: 'https://naturalgarden.am/api',
  ...
  /** Ventilation PID (cooling): open/close window relays in Automatic mode (not Manual lock). */
  ventilationPidEnabled: false,
  sonoffVentOpenDeviceId: '',
  sonoffVentOpenChannel: 2,
  sonoffVentCloseDeviceId: '',
  sonoffVentCloseChannel: 1,
  ventilationPidDeadbandC: 0.25,
  ventilationPidCommandThreshold: 0.1,
  ventilationPidMinDemandPct: 5,
  ventilationPidPositionDeadbandPct: 2,
  ventilationPidMinMsBetweenVentMoves: 800,
